...
if ((isset($_SERVER['HTTP_REFERER'])) && (((isset($_SESSION['loginUsername'])) && ($_SESSION['userLevel'] <= 1)) || ($section == "setup"))) {
	...
	$data = array(
		...
		'prefsStripeEnabled' => sterilize($_POST['prefsStripeEnabled']),
		'prefsStripeTestPublicKey' => sterilize($_POST['prefsStripeTestPublicKey']),
		'prefsStripeTestPrivateKey' => sterilize($_POST['prefsStripeTestPrivateKey']),
		'prefsStripeLivePublicKey' => sterilize($_POST['prefsStripeLivePublicKey']),
		'prefsStripeLivePrivateKey' => sterilize($_POST['prefsStripeLivePrivateKey']),
