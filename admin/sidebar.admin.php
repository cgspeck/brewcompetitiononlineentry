...
if ($logged_in) {
	...
	$page_info100 .= "<span class=\"pull-right\"><a href=\"".$base_url."index.php?section=admin&amp;go=count_by_substyle\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View the entry counts broken down by sub-style\"><small>Sub-Style</small></a></span>";
	$page_info100 .= "</div>";
